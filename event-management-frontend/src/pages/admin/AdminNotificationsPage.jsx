...
import { Bell, Check, CheckCheck, AlertTriangle, CheckCircle, Info, Trash2 } from "lucide-react";
...
const typeConfig = {
  ...
  NEW_REQUEST: { icon: Bell, color: "#2563eb", bg: "#eff6ff", label: "New Request" },
      ...
      <div style={{
        ...
        {loading ? (
          ...
          <div style={{ padding: "3rem", textAlign: "center", color: "var(--color-slate-400)" }}>
            ...
            <p style={{ fontSize: "0.85rem", marginTop: "0.25rem" }}>You'll see notifications here when vendors respond to service requests.</p>
          </div>
        ) : (
