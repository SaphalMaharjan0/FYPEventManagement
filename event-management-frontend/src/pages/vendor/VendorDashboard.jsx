...
export default function VendorDashboard({ currentUser }) {
  const StatCard = ({ icon: Icon, title, value, subtitle, iconColor, iconBg }) => (
    <div style={{ backgroundColor: "white", padding: "1.5rem", borderRadius: "0.75rem", border: "1px solid #e2e8f0", display: "flex", alignItems: "flex-start", gap: "1.5rem", boxShadow: "0 1px 2px rgba(0,0,0,0.05)" }}>
      ...
      <div>
        ...
        <h3 style={{ fontSize: "2rem", fontWeight: "bold", color: "#0f172a", marginBottom: "0.25rem", lineHeight: "1" }}>{value}</h3>
  ...
  return (
    <div style={{ maxWidth: "1400px", margin: "0 auto" }}>
      <div style={{ marginBottom: "2rem" }}>
        <h1 style={{ fontSize: "1.75rem", fontWeight: "bold", color: "#0f172a", marginBottom: "0.25rem" }}>Vendor Dashboard</h1>
        <p style={{ color: "#64748b", fontSize: "0.95rem" }}>Manage your services and track performance.</p>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: "1.5rem" }}>
        ...
        <div style={{ backgroundColor: "white", borderRadius: "0.75rem", border: "1px solid #e2e8f0", padding: "1.5rem" }}>
          <h2 style={{ fontSize: "1.25rem", fontWeight: "bold", color: "#0f172a", marginBottom: "1.5rem" }}>Revenue This Month</h2>
          
          {/* Mock Line Chart with CSS/SVG */}
          <div style={{ height: "300px", width: "100%", position: "relative" }}>
            {/* Y-axis labels */}
            <div style={{ position: "absolute", left: 0, top: 0, bottom: "30px", width: "40px", display: "flex", flexDirection: "column", justifyContent: "space-between", color: "#94a3b8", fontSize: "0.75rem" }}>
              <span>$120k</span>
              <span>$90k</span>
              <span>$60k</span>
              <span>$30k</span>
            ...
            {/* X-axis labels */}
            <div style={{ position: "absolute", left: "40px", right: 0, bottom: 0, height: "30px", display: "flex", justifyContent: "space-between", alignItems: "flex-end", color: "#94a3b8", fontSize: "0.75rem", padding: "0 10px" }}>
              <span>May</span>
              <span>Jun</span>
              <span>Jul</span>
              <span>Aug</span>
        ...
        <div style={{ backgroundColor: "white", borderRadius: "0.75rem", border: "1px solid #e2e8f0", padding: "1.5rem" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5rem" }}>
            <h2 style={{ fontSize: "1.25rem", fontWeight: "bold", color: "#0f172a" }}>Recent Requests</h2>
            <button style={{ background: "none", border: "none", color: "#3b82f6", fontSize: "0.85rem", fontWeight: "600", cursor: "pointer" }}>View all</button>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            {[
              ...
              <div key={i} style={{ padding: "1rem", backgroundColor: "#f8fafc", borderRadius: "0.5rem", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div>
                  <h4 style={{ fontWeight: "600", color: "#0f172a", fontSize: "0.95rem", marginBottom: "0.25rem" }}>{req.client}</h4>
                  <p style={{ color: "#64748b", fontSize: "0.8rem" }}>{req.service}</p>
                </div>
                <span style={{ 
